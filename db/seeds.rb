...
crs2 = Course.create({name:"Robotics basic", description: "Course description robots, machines", category_id: cat1.id})
CourseStudent.create({course_id: crs1.id, student_id: student1.id, author: false})